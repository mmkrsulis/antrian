...
"$BT/aapt2" link -I "$JAR" --manifest "$SRC/AndroidManifest.xml" --min-sdk-version 26 --target-sdk-version 35 --version-code 1 --version-name 1.0.0 --java "$OUT/generated" -o "$OUT/base.apk" "$OUT/resources.zip"
