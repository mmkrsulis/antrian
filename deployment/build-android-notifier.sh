...
"$BT/aapt2" link -I "$JAR" --manifest "$SRC/AndroidManifest.xml" --min-sdk-version 26 --target-sdk-version 35 --version-code 10 --version-name 1.3.4 --java "$OUT/generated" -o "$OUT/base.apk" "$OUT/resources.zip"
find "$SRC/src" "$OUT/generated" -name '*.java' -print0 | xargs -0 javac -J-Xmx384m -source 8 -target 8 -bootclasspath "$JAR" -d "$OUT/classes"
