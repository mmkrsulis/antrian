...
"$BT/aapt2" link -I "$JAR" --manifest "$SRC/AndroidManifest.xml" --min-sdk-version 26 --target-sdk-version 35 --version-code 9 --version-name 1.3.3 --java "$OUT/generated" -o "$OUT/base.apk" "$OUT/resources.zip"
