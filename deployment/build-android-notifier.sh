...
"$BT/aapt2" link -I "$JAR" --manifest "$SRC/AndroidManifest.xml" --min-sdk-version 26 --target-sdk-version 35 --version-code 8 --version-name 1.3.2 --java "$OUT/generated" -o "$OUT/base.apk" "$OUT/resources.zip"
