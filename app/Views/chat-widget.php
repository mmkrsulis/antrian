...
<section class="internal-chat-panel" id="internal-chat-panel" aria-label="Chat operator" hidden>
    <header><div><b>Chat Operator</b><small>Internal · tidak tampil di kiosk dan display</small></div><button type="button" id="internal-chat-close" aria-label="Tutup chat">×</button></header>
